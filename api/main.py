...
# TEMPORARY: Basic Auth Middleware DISABLED
# Basic Auth should ONLY protect /admin-dashboard-v2
# Currently disabled for debugging - re-enable when needed
...
async def serve_admin_dashboard_clean(request: Request):
    """
    Clean URL: /admin-dashboard → serves V2 by default (public, no auth)
    Query params:
